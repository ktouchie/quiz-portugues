...
/**
 * Advanced setup for Gender & Plural (docs/MOBILE_APP_SPEC.md §8, GitHub #51): pick categories,
...
fun GenderSetupScreen(
    ...
    viewModel: GenderSetupViewModel = viewModel(),
) {
    ...
    Column(
        ...
        Text("Avançado · Género & Plural", style = MaterialTheme.typography.headlineSmall)
        Text(
